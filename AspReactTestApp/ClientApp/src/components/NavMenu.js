...
export default function NavMenu() {
    ...
    return (
        <header>
            ...
            <nav className="bg-gray-900 border-gray-200 w-100 py-2 px-2">
                <div className="w-75 flex flex-wrap items-center justify-between mx-auto ">
                    ...
                    <div className="flex flex-row hidden w-full md:block md:w-auto" id="navbar-default">
                        <ul className="font-medium flex flex-col p-4 md:p-0 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            <li>
                    ...
                    <Menu as="div" className="relative inline-block text-left">
                        <div>
                            ...
                            >
                                <img src='/UserLogo2.jpeg' className='border rounded-full rounded-full' alt='Description of the image' />
                            </Menu.Button>
                        </div>
