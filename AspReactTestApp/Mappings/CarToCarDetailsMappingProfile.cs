...
public class CarToCarDetailsMappingProfile : Profile
{
    ...
    {
        int? languageId = null;
        CreateProjection<Car, CarDetailsDTO>()
            ...
            .ForMember(dest => dest.Color, opt => opt.MapFrom((src) => src.Color.ColorLocales.FirstOrDefault(c => c.LanguageId == languageId).Name))
            .ForMember(dest => dest.Market, opt => opt.MapFrom(src => src.Market.MarketLocales.FirstOrDefault(m => m.LanguageId == languageId).Name))
            .ForMember(dest => dest.Region, opt => opt.MapFrom(src => src.Region.RegionLocales.FirstOrDefault(r => r.LanguageId == languageId).Name))
            .ForMember(dest => dest.Category, opt => opt.MapFrom(src => src.Category.CategoryLocales.FirstOrDefault(c => c.LanguageId == languageId).Name))
            .ForMember(dest => dest.FuelType, opt => opt.MapFrom(src => src.Fueltype.FuelTypeLocales.FirstOrDefault(f => f.LanguageId == languageId).Name))
            .ForMember(dest => dest.GearType, opt => opt.MapFrom(src => src.GearType.GearTypeLocales.FirstOrDefault(g => g.LanguageId == languageId).Name))
            ...
            .ForMember(dest => dest.Features, opt => opt.MapFrom(src => src.Features.Select(f => f.FeatureLocales.FirstOrDefault(f => f.LanguageId == languageId).Name).ToList()))
            ...
            .ForMember(dest => dest.AutoSalonSlogan, opt => opt.MapFrom(src => src.AutoSalon.AutoSalonLocales.FirstOrDefault(a => a.LanguageId == languageId).Slogan))
            .ForMember(dest => dest.AutoSalonDescription, opt => opt.MapFrom(src => src.AutoSalon.AutoSalonLocales.FirstOrDefault(a => a.LanguageId == languageId).Description))
            .ForMember(dest => dest.AutoSalonLocation, opt => opt.MapFrom(src => src.AutoSalon.AutoSalonLocales.FirstOrDefault(a => a.LanguageId == languageId).Location));
    }
}
